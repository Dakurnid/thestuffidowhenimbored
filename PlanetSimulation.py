...
class Planet:
    AU = 149.6e6 * 1000
    G = 6.67428e-11
    SCALE = 190 / AU #1AU (Basicaly The Distance)= 100px
    TIMESTEP = 3600*24 #THE PLANETS WILL MOVE FASTER BY DAYS
    ...
    def attraction(self, otherplanet):
        otherplanet_x , otherplanet_y = otherplanet.x, otherplanet.y
        distance_x = otherplanet_x -  self.x
        distance_y = otherplanet_y - self.y
